...
<div>
    <img className='w-[150px] h-[150px]' src={process.env.PUBLIC_URL+"/imgs/Profile-Pic-S.svg"} alt="" />
</div>
...
<a className='px-10 py-3 font-semibold cursor-pointer rounded-md bg-[#0095F6] text-white'> Follow</a>
<BsThreeDots className='text-3xl cursor-pointer'/>
</div>
<div className='flex space-x-20 items-center'>
    <p><span className='font-semibold'> 1.365</span> posts</p>
    <p><span className='font-semibold'> 5M</span> followers</p>
    <p><span className='font-semibold'> 1.697</span> following </p>
